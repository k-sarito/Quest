...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        {
            return ($"{this.Name} has a robe that is {this.ColorfulRobe.Length} stuff long and has the colors: {String.Join(", ", ColorfulRobe.Colors)}. They also have a {ShinyHat.ShininessDescription} hat.");
        }
